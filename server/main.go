...
import (
	...
	"github.com/jtreu/sleeplog-app/server/infrastructure"
	"github.com/jtreu/sleeplog-app/server/interfaces/repository"
	"github.com/jtreu/sleeplog-app/server/interfaces/web"
	"github.com/jtreu/sleeplog-app/server/usecase"
...
func main() {
	...
	mailHandlerOptions := infrastructure.MailHandlerOptions{
		Domain:        "mg.enoplay.com",
		PrivateApiKey: "key-d43f47cf9268ce48c3f9c468921ae069",
		PublicApiKey:  "pubkey-c10c3e0144470f72adee6fc3a8728882",
	}
	...
	// router.Get("/.well-known/acme-challenge/ENfg7ya9gFfKac4PNzm78Wcptbne3_bhqLmRHRw7iNQ", http.HandlerFunc(w.GetCertBotKey)) // Certbot - Certificate verification
